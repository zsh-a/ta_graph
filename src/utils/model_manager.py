...
def get_l2_model() -> ChatOpenAI:
    ...
    用于最终确认和复杂形态识别，成本高，能力强。
    默认使用 qwen-vl-max (ModelScope API)
    
    环境变量:
        L2_MODEL_NAME: 模型名称，默认 "Qwen/Qwen3-VL-30B-A3B-Thinking"
    """
    model_name = os.getenv("L2_MODEL_NAME", "Qwen/Qwen3-VL-30B-A3B-Thinking")

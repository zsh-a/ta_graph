                        ...
                        <>
                            ...
                            <div className="flex-1 glass-card rounded-xl flex flex-col overflow-hidden">
                                ...
                                <div className="flex-1 overflow-y-auto p-6 custom-scrollbar space-y-4">
                                    {(() => {
                                        // Unify all events into a single timeline sorted by timestamp
                                        ...
                                        return timelineEvents.map((event: any, idx: number) => {
                                            if (event.type === 'observation') {
                                                return (
                                                    <div key={`obs-${idx}`} className="relative pl-8 border-l-2 border-primary/20 pb-4 last:pb-0 group">
                                            ...
                                            if (event.type === 'analysis') {
                                                return (
                                                    <div key={`ana-${idx}`} className="relative pl-8 border-l-2 border-accent/20 pb-4 last:pb-0 group">
                                                        ...
                                                        <div className="p-4 bg-muted/20 hover:bg-muted/30 transition-colors rounded-xl border border-border/50 text-sm">
                                                            ...
                                                            {event.content && event.content.recommended_action && (
                                            ...
                                            if (event.type === 'decision') {
                                                return (
                                                    <div key={`dec-${idx}`} className="relative pl-8 border-l-2 border-primary/20 pb-4 last:pb-0 group">
                                                        <div className="absolute -left-[9px] top-0 p-1 bg-background border-2 border-primary rounded-full transition-transform group-hover:scale-110">
                                                        ...
                                                        <div className="p-4 bg-muted/20 hover:bg-muted/30 transition-colors rounded-xl border border-border/50 text-sm">
                                                            <div className="flex items-center gap-6 mb-3">
                                                                ...
                                                                <div className="flex flex-col">
                                                                    ...
                                                                    <span className="font-bold text-lg">{(event.probability_score * 100).toFixed(0)}%</span>
                                                                </div>
                                                                {event.wait_reason && (
                                                                    <div className="flex flex-col">
                                            ...
                                            if (event.type === 'execution') {
                                                return (
                                                    <div key={`exc-${idx}`} className="relative pl-8 border-l-2 border-primary/20 pb-4 last:pb-0 group">
                                                        <div className="absolute -left-[9px] top-0 p-1 bg-background border-2 border-primary rounded-full transition-transform group-hover:scale-110">
